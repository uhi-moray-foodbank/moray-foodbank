...
<form method="post" class="volunteer-form">
	Forename: &nbsp; <input type = "text" name="forename"  <?php if($_SESSION['search_for']==1){echo 'value="'.$_SESSION['search_for'].'"';}?>>
	Surname: &nbsp; <input type = "text" name="surname"  <?php if($_SESSION['search_sur']==1){echo 'value="'.$_SESSION['search_sur'].'"';}?>>
	<label>&nbsp;&nbsp; Days: </label>
	...
	Include Target Groups? <input type="checkbox" name = "targets" <?php if ($_SESSION['search_target']==1){ echo "checked";} ?>>
